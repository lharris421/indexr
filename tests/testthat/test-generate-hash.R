...
test_that("generate_hash produces consistent results", {
...
test_that("generate_hash handles NAs appropriately", {
  ...
  expect_equal(hash_with_na, hash_without_na)
})

test_that("generate_hash respects alphabetical_order", {
  ...
  expect_equal(hash_unordered, hash_ordered)
})
